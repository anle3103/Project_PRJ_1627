                                                ...
                                                <div class="contain-product layout-default">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="price">
                                                            ...
                                                            <div class="buttons">
                                                                <a href="./ProductDetails?pid=${p.getId()}" style="background-color:#76ffff; " class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Show more</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="container">
                        <div class="biolife-tab biolife-tab-contain sm-margin-top-34px">
                            <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                                <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                    <li class="tab-element">
                                        <h1 style="color: black; font-weight: 600; ">Hoa Tang Sinh nhat</h1>
