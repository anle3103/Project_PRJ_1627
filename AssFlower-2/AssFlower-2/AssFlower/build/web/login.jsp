                            ...
                            <div class="signin-container">
                                ...
                                <form action="./login" name="frm-login" method="post">
                                    ...
                                    <p class="form-row wrap-btn">
                                        <button class="btn btn-submit btn-bold" style="background-color: #00ffff" type="submit">login</button>
                                    </p>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="signin-container">
                                ...
                                <form action="register" name="frm-login" method="post">
                                    ...
                                    <p class="form-row wrap-btn">
                                        <button class="btn btn-submit btn-bold" style="background-color: #00ffff" type="submit">Register</button>
                                    </p>
                                </form>
                            </div>
                        </div>
