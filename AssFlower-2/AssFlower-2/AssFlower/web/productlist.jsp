                                ...
                                <c:forEach var="p" items="${plist}">
                                    ...
                                    <li class="product-item col-lg-4 col-xs-6">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                <h4 class="product-title" style="margin-top: 45px;"><a href="./ProductDetails?pid=${p.getId()}" class="pr-name">${p.getName()}</a></h4>
                                                <div class="price">
                                                    <ins><span class="price-amount">Price: <span class="currencySymbol">$</span>${p.getPrice()}</span></ins>
                                                    <div class="buttons">
                                                        <a href="./AddToCart?pid=${p.getId()}&quantity=1" style="background-color:#76ffff; " class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>add to cart</a>
                                                    </div>
                                                </div>
